...
//    String uid,name;
   // GoogleSignInClient mGoogleSignInClient;
    ...
    Adapter_normal grid_adapter;

    List<Models_Home_normal> models;
    Integer[] colors = null;
...
//
        ...
        //fragment
        sNavigationDrawer = findViewById(R.id.navigationDrawer_normal);
...
//        id.setText(uid);
        ...
        models = new ArrayList<>();
        models.add(new Models_Home_normal(R.drawable.travel_planner_1,"Plan Travel"));
        models.add(new Models_Home_normal(R.drawable.places_around_2,"Places Around"));
        models.add(new Models_Home_normal(R.drawable.explore,"Explore"));
        grid_adapter=new Adapter_normal(models,this);
        viewPager = findViewById(R.id.viewPager_menu_normal);
